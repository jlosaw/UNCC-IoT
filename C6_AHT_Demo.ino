...
#include <SparkFun_Qwiic_Humidity_AHT20.h> //Delete this line and re-add it from the library. Note: you may have to delete parts of the name until it matches "SparkFun_Qwiic_Humidity_AHT20.h"
